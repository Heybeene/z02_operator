...
public class OpExample { // 예제 코드 작성용 클래스로 사용
	
	// ex1() 라는 메소드를 만듦
	// -> OpExample이 가지고 있는 기능 중 ex1()이라는 기능이다. 
	
	public void ex1() {
		// syso 작성 후 ctrl + space를 치면 밑에와 같이 나온다
	...
	public void ex3() {
		...
		// - 다른 연산자보다 나중에 증가하거나 감소한다 

		int temp2 = 3;
		System.out.println(temp2-- +2);
						// 여기는 일단 무시하고 3+2 = 5라는 값이 나왔고
						// temp2 = 2; (1감소) 
		...
		int b = 5;
		int c = a++ + --b;
				// 대입 연산자, 증감 연산자, + , 감소 연산자가 있음 4가지의 연산자 존재 
	    
		// 		(a)3++ + --5(b)
		// c = 	(a)3++ + 4(b)
		// c =  7		
				
		// 최종적으로 a, b , c는 각각 얼마인가? 7
	...
	// 와, 그리고(~이고), ~면서, ~이면서, ~부터, ~까지, ~사이라고 해석가능 
	
	// ex) 사과와 바나나, 사과 그리고 바나나, 사과 이면서 바나나로 해석가능 
	
	int a = 101;
	System.out.println(a >= 100); // a는 100이상 ?
	System.out.println(a % 2 == 0); // a는 짝수인가 ?

	// a는 100이상 이면서 짝수 인가?
	
	System.out.println((a >= 100) && (a % 2 == 0)); // a는 100이상 ?
	...
	// || (OR) 연산자 : 둘 다 false 이면 false 같이 나오고, 나머지는 true (AND의 반대)
	// 또는, ~거나, ~이거나, 
	...
	System.out.println( (c > 10) || (c % 2 == 0) );
 	...
 	public void ex6() {
 		...
 		System.out.printf("%d은/는 1 미만, 100초과 정수인가? %b\n", input, result2);
	...
	public void ex8() {
		...
		// - 조건식의 결과가 true이면 식1를 수행하고 
		// - 조건식의 결과가 false이면 식2를 수행하는 연산이다
		
		// * 조건식이 뭐냐 연산 결과가 true / false인 식
		//				(비교, 논리, 논리 부정 연산이 포함)
